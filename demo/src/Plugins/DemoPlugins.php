...
class DemoPlugins extends \Tabby\Framework\PluginAbstract
{
    /**
     * 路由之前,第一个钩子
    ...
    {
        //\T::$Log->info(static::class . '::' . __FUNCTION__ . '_' . \Tabby\Utils\Random::string(10));
    }
    ...
    {
        // 在这个 AOP钩子 里注册了通用验证规则
        // 里面包含了 page_size, page_num ...
        \Rules\CommonRules::uses();
    }
